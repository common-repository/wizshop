...
?>
<div data-wiz-status-report="perm-cart" data-wizshop class="stat_div basket-add-message p-3 mb-3 w-100 v_ihide">
...
<div id="wiz-perm-cart" class="v_cart v_ihide" data-wiz-shopping-list='FX' data-wizshop data-auto-hide>
<div data-wiz-list-container class="basket-table responsive-table basket-flex w-100">
	<div class="basket-thead row justify-content-between  align-items-center mx-0 no-gutters px-md-2 hide-xs" data-wiz-list-head>
		...
		<aside class="product-info mxw-100 flex-grow-1 col-md-11 col-8 row align-items-center justify-content-between pr-3">
			...
			<div class="product-delete col-md-2"></div>
		</aside>
	</div>
	<div data-wiz-list-item class="align-items-center justify-content-between mx-0 no-gutters row basket-row py-2 px-md-2">
		...
		<aside class="align-items-center col-9 col-md-11 flex-grow-1 justify-content-between mxw-100 pr-3 product-info row">	
			...
			<div class="product-price col-12 col-md-2 pb-2 pb-md-0" >
			...
			<div class="product-quantity col-12 col-md-2 row pb-2 pb-md-0 no-gutters">
				...
				<span class="{{dispPacks}} {{dispCart}}  col-md-12 col-4 pr-2 pr-md-0">
			...
			<div class="product-addtocart col-md-2 col-auto text-left text-right-xs pb-2 pb-md-0">
				...
				<a href="javascript:void(0);" data-wiz-item-to-cart='{{Key}}' data-wiz-packs-ctrl="{{PacksId}}" data-wiz-quant-ctrl="{{QuantId}}" data-wiz-check-quant="1" data-wiz-item-row data-wiz-item-col data-wiz-status="perm-cart||15" class="{{dispCart}} link">
			...
			<div class="product-delete col-auto col-md-2 pb-2 pb-md-0 text-left text-right-xs">
				<a href="javascript:void(0);" data-wiz-list-action-item='{{Key}}' data-wiz-matrix-key='{{matrixKey}}' data-wiz-type='FX' data-wiz-action='3' data-wiz-status="perm-cart||15" class="link">
...
<div data-wiz-list-to-cart class="v_ihide my-3 text-left" data-wiz-status="perm-cart||15">
	<a href="javascript:void(0);" class="btn primary"><?php _e('הוספת רשימה לסל קניות', wizshop_pages)?></a>
	<a href="<?php echo esc_url(wizshop_get_cart_url())?>"  data-wiz-type='FX-LIST' class="v_ihide btn primary-outline" ><?php _e('הצגת סל', wizshop_pages)?></a>
</div>
</div>
<div class="empty-basket">
	<p class="cart-empty"><?php _e('הסל הקבוע ריק כרגע', wizshop_pages)?>. </p>
	<p class="cart-empty"> <?php _e('ליצירת סל קבוע העבר פריטים מקניות קודמות', wizshop_pages)?>. </p>
	<a class="btn primary-outline" href="#prevcart"><?php _e('לקניות קודמות', wizshop_pages)?></a>
</div>